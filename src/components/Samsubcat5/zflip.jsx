...
import banner from "../../Images/zflip-banner.png"
import "./zflip.css"
...
const SamsungZFlip = () => {
  ...
  return (
    <Fragment>
      ...
      <div>
        <Section title="Galaxy Z Flip 5 Cases" bgColor="#bdc3c7" productItems={discoutProducts} addToCart={addToCart} />
